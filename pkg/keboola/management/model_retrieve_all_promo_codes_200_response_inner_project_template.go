...
// checks if the RetrieveAllPromoCodes200ResponseInnerProjectTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RetrieveAllPromoCodes200ResponseInnerProjectTemplate{}

// RetrieveAllPromoCodes200ResponseInnerProjectTemplate struct for RetrieveAllPromoCodes200ResponseInnerProjectTemplate
type RetrieveAllPromoCodes200ResponseInnerProjectTemplate struct {
...
func NewRetrieveAllPromoCodes200ResponseInnerProjectTemplate() *RetrieveAllPromoCodes200ResponseInnerProjectTemplate {
	this := RetrieveAllPromoCodes200ResponseInnerProjectTemplate{}
	return &this
}
...
func (o *RetrieveAllPromoCodes200ResponseInnerProjectTemplate) SetStringId(v string) {
	o.StringId = &v
}
...
func (o RetrieveAllPromoCodes200ResponseInnerProjectTemplate) MarshalJSON() ([]byte, error) {
...
func (o RetrieveAllPromoCodes200ResponseInnerProjectTemplate) ToMap() (map[string]interface{}, error) {
...
type NullableRetrieveAllPromoCodes200ResponseInnerProjectTemplate struct {
	value *RetrieveAllPromoCodes200ResponseInnerProjectTemplate
	isSet bool
}

func (v NullableRetrieveAllPromoCodes200ResponseInnerProjectTemplate) Get() *RetrieveAllPromoCodes200ResponseInnerProjectTemplate {
	return v.value
}

func (v *NullableRetrieveAllPromoCodes200ResponseInnerProjectTemplate) Set(val *RetrieveAllPromoCodes200ResponseInnerProjectTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableRetrieveAllPromoCodes200ResponseInnerProjectTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableRetrieveAllPromoCodes200ResponseInnerProjectTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRetrieveAllPromoCodes200ResponseInnerProjectTemplate(val *RetrieveAllPromoCodes200ResponseInnerProjectTemplate) *NullableRetrieveAllPromoCodes200ResponseInnerProjectTemplate {
	return &NullableRetrieveAllPromoCodes200ResponseInnerProjectTemplate{value: val, isSet: true}
}

func (v NullableRetrieveAllPromoCodes200ResponseInnerProjectTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRetrieveAllPromoCodes200ResponseInnerProjectTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
