...
// checks if the UpdateAUserRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAUserRequest{}

// UpdateAUserRequest struct for UpdateAUserRequest
...
func (o UpdateAUserRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateAUserRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateAUserRequest struct {
	value *UpdateAUserRequest
	isSet bool
}

func (v NullableUpdateAUserRequest) Get() *UpdateAUserRequest {
	return v.value
}

func (v *NullableUpdateAUserRequest) Set(val *UpdateAUserRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateAUserRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateAUserRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateAUserRequest(val *UpdateAUserRequest) *NullableUpdateAUserRequest {
	return &NullableUpdateAUserRequest{value: val, isSet: true}
}

func (v NullableUpdateAUserRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateAUserRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
