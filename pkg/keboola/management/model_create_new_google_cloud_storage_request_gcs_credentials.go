...
// checks if the CreateNewGoogleCloudStorageRequestGcsCredentials type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNewGoogleCloudStorageRequestGcsCredentials{}

// CreateNewGoogleCloudStorageRequestGcsCredentials struct for CreateNewGoogleCloudStorageRequestGcsCredentials
type CreateNewGoogleCloudStorageRequestGcsCredentials struct {
...
type _CreateNewGoogleCloudStorageRequestGcsCredentials CreateNewGoogleCloudStorageRequestGcsCredentials
...
func NewCreateNewGoogleCloudStorageRequestGcsCredentials(type_ string, projectId string, privateKeyId string, privateKey string, clientEmail string, clientId string, authUri string, tokenUri string, authProviderX509CertUrl string, clientX509CertUrl string) *CreateNewGoogleCloudStorageRequestGcsCredentials {
	this := CreateNewGoogleCloudStorageRequestGcsCredentials{}
	this.Type = type_
...
func (o *CreateNewGoogleCloudStorageRequestGcsCredentials) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
// and a boolean to check if the value has been set.
func (o *CreateNewGoogleCloudStorageRequestGcsCredentials) GetPrivateKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *CreateNewGoogleCloudStorageRequestGcsCredentials) GetAuthUriOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o CreateNewGoogleCloudStorageRequestGcsCredentials) MarshalJSON() ([]byte, error) {
...
func (o CreateNewGoogleCloudStorageRequestGcsCredentials) ToMap() (map[string]interface{}, error) {
...
func (o *CreateNewGoogleCloudStorageRequestGcsCredentials) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNewGoogleCloudStorageRequestGcsCredentials := _CreateNewGoogleCloudStorageRequestGcsCredentials{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateNewGoogleCloudStorageRequestGcsCredentials)

	if err != nil {
		return err
	}

	*o = CreateNewGoogleCloudStorageRequestGcsCredentials(varCreateNewGoogleCloudStorageRequestGcsCredentials)

	return err
}

type NullableCreateNewGoogleCloudStorageRequestGcsCredentials struct {
	value *CreateNewGoogleCloudStorageRequestGcsCredentials
	isSet bool
}

func (v NullableCreateNewGoogleCloudStorageRequestGcsCredentials) Get() *CreateNewGoogleCloudStorageRequestGcsCredentials {
	return v.value
}

func (v *NullableCreateNewGoogleCloudStorageRequestGcsCredentials) Set(val *CreateNewGoogleCloudStorageRequestGcsCredentials) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNewGoogleCloudStorageRequestGcsCredentials) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNewGoogleCloudStorageRequestGcsCredentials) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNewGoogleCloudStorageRequestGcsCredentials(val *CreateNewGoogleCloudStorageRequestGcsCredentials) *NullableCreateNewGoogleCloudStorageRequestGcsCredentials {
	return &NullableCreateNewGoogleCloudStorageRequestGcsCredentials{value: val, isSet: true}
}

func (v NullableCreateNewGoogleCloudStorageRequestGcsCredentials) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNewGoogleCloudStorageRequestGcsCredentials) UnmarshalJSON(src []byte) error {
	v.isSet = true
