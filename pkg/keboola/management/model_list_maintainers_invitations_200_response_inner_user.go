...
// checks if the ListMaintainersInvitations200ResponseInnerUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListMaintainersInvitations200ResponseInnerUser{}

// ListMaintainersInvitations200ResponseInnerUser struct for ListMaintainersInvitations200ResponseInnerUser
type ListMaintainersInvitations200ResponseInnerUser struct {
...
func NewListMaintainersInvitations200ResponseInnerUser() *ListMaintainersInvitations200ResponseInnerUser {
	this := ListMaintainersInvitations200ResponseInnerUser{}
	return &this
}
...
func (o ListMaintainersInvitations200ResponseInnerUser) MarshalJSON() ([]byte, error) {
...
func (o ListMaintainersInvitations200ResponseInnerUser) ToMap() (map[string]interface{}, error) {
...
type NullableListMaintainersInvitations200ResponseInnerUser struct {
	value *ListMaintainersInvitations200ResponseInnerUser
	isSet bool
}

func (v NullableListMaintainersInvitations200ResponseInnerUser) Get() *ListMaintainersInvitations200ResponseInnerUser {
	return v.value
}

func (v *NullableListMaintainersInvitations200ResponseInnerUser) Set(val *ListMaintainersInvitations200ResponseInnerUser) {
	v.value = val
	v.isSet = true
}

func (v NullableListMaintainersInvitations200ResponseInnerUser) IsSet() bool {
	return v.isSet
}

func (v *NullableListMaintainersInvitations200ResponseInnerUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListMaintainersInvitations200ResponseInnerUser(val *ListMaintainersInvitations200ResponseInnerUser) *NullableListMaintainersInvitations200ResponseInnerUser {
	return &NullableListMaintainersInvitations200ResponseInnerUser{value: val, isSet: true}
}

func (v NullableListMaintainersInvitations200ResponseInnerUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListMaintainersInvitations200ResponseInnerUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
