...
// checks if the CreateAMaintainerRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAMaintainerRequest{}

// CreateAMaintainerRequest struct for CreateAMaintainerRequest
type CreateAMaintainerRequest struct {
	// Maintainer name
...
type _CreateAMaintainerRequest CreateAMaintainerRequest
...
func (o CreateAMaintainerRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateAMaintainerRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateAMaintainerRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAMaintainerRequest := _CreateAMaintainerRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAMaintainerRequest)

	if err != nil {
		return err
	}

	*o = CreateAMaintainerRequest(varCreateAMaintainerRequest)

	return err
}

type NullableCreateAMaintainerRequest struct {
	value *CreateAMaintainerRequest
	isSet bool
}

func (v NullableCreateAMaintainerRequest) Get() *CreateAMaintainerRequest {
	return v.value
}

func (v *NullableCreateAMaintainerRequest) Set(val *CreateAMaintainerRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAMaintainerRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAMaintainerRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAMaintainerRequest(val *CreateAMaintainerRequest) *NullableCreateAMaintainerRequest {
	return &NullableCreateAMaintainerRequest{value: val, isSet: true}
}

func (v NullableCreateAMaintainerRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAMaintainerRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
