...
type CreateProject201Response struct {
	...
	Limits *CreateProject201ResponseLimits `json:"limits,omitempty"`
...
func (o *CreateProject201Response) GetLimits() CreateProject201ResponseLimits {
	if o == nil || IsNil(o.Limits) {
		var ret CreateProject201ResponseLimits
		return ret
	}
	return *o.Limits
}
...
// SetLimits gets a reference to the given CreateProject201ResponseLimits and assigns it to the Limits field.
