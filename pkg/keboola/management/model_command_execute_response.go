...
// checks if the CommandExecuteResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommandExecuteResponse{}

// CommandExecuteResponse struct for CommandExecuteResponse
...
type _CommandExecuteResponse CommandExecuteResponse
...
func (o CommandExecuteResponse) MarshalJSON() ([]byte, error) {
...
func (o CommandExecuteResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["commandExecutionId"] = o.CommandExecutionId
	return toSerialize, nil
}

func (o *CommandExecuteResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCommandExecuteResponse := _CommandExecuteResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommandExecuteResponse)

	if err != nil {
		return err
	}

	*o = CommandExecuteResponse(varCommandExecuteResponse)

	return err
}

type NullableCommandExecuteResponse struct {
	value *CommandExecuteResponse
	isSet bool
}

func (v NullableCommandExecuteResponse) Get() *CommandExecuteResponse {
	return v.value
}

func (v *NullableCommandExecuteResponse) Set(val *CommandExecuteResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCommandExecuteResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCommandExecuteResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommandExecuteResponse(val *CommandExecuteResponse) *NullableCommandExecuteResponse {
	return &NullableCommandExecuteResponse{value: val, isSet: true}
}

func (v NullableCommandExecuteResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommandExecuteResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
