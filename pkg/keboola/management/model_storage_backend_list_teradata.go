...
// checks if the StorageBackendListTeradata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageBackendListTeradata{}

// StorageBackendListTeradata struct for StorageBackendListTeradata
type StorageBackendListTeradata struct {
	Id float32 `json:"id"`
	// east-1 (required)
...
type _StorageBackendListTeradata StorageBackendListTeradata
...
func NewStorageBackendListTeradata(id float32, owner string, created string, host string, backend string) *StorageBackendListTeradata {
	this := StorageBackendListTeradata{}
	this.Id = id
	this.Owner = owner
...
func (o StorageBackendListTeradata) MarshalJSON() ([]byte, error) {
...
func (o StorageBackendListTeradata) ToMap() (map[string]interface{}, error) {
...
func (o *StorageBackendListTeradata) UnmarshalJSON(data []byte) (err error) {
	...
	varStorageBackendListTeradata := _StorageBackendListTeradata{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStorageBackendListTeradata)

	if err != nil {
		return err
	}

	*o = StorageBackendListTeradata(varStorageBackendListTeradata)

	return err
}

type NullableStorageBackendListTeradata struct {
	value *StorageBackendListTeradata
	isSet bool
}

func (v NullableStorageBackendListTeradata) Get() *StorageBackendListTeradata {
	return v.value
}

func (v *NullableStorageBackendListTeradata) Set(val *StorageBackendListTeradata) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageBackendListTeradata) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageBackendListTeradata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageBackendListTeradata(val *StorageBackendListTeradata) *NullableStorageBackendListTeradata {
	return &NullableStorageBackendListTeradata{value: val, isSet: true}
}

func (v NullableStorageBackendListTeradata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageBackendListTeradata) UnmarshalJSON(src []byte) error {
	v.isSet = true
