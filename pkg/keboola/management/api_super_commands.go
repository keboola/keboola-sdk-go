...
// SUPERCommandsAPIService SUPERCommandsAPI service
type SUPERCommandsAPIService service

type ApiRunCommandRequest struct {
	ctx context.Context
	ApiService *SUPERCommandsAPIService
...
func (r ApiRunCommandRequest) Execute() (*PurgeDeletedProject200Response, *http.Response, error) {
...
*/
func (a *SUPERCommandsAPIService) RunCommand(ctx context.Context) ApiRunCommandRequest {
	return ApiRunCommandRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SUPERCommandsAPIService) RunCommandExecute(r ApiRunCommandRequest) (*PurgeDeletedProject200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SUPERCommandsAPIService.RunCommand")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/manage/commands"
