...
// checks if the ABSCreatedAllOfCreator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ABSCreatedAllOfCreator{}

// ABSCreatedAllOfCreator struct for ABSCreatedAllOfCreator
type ABSCreatedAllOfCreator struct {
...
func (o ABSCreatedAllOfCreator) MarshalJSON() ([]byte, error) {
...
func (o ABSCreatedAllOfCreator) ToMap() (map[string]interface{}, error) {
...
type NullableABSCreatedAllOfCreator struct {
	value *ABSCreatedAllOfCreator
	isSet bool
}

func (v NullableABSCreatedAllOfCreator) Get() *ABSCreatedAllOfCreator {
	return v.value
}

func (v *NullableABSCreatedAllOfCreator) Set(val *ABSCreatedAllOfCreator) {
	v.value = val
	v.isSet = true
}

func (v NullableABSCreatedAllOfCreator) IsSet() bool {
	return v.isSet
}

func (v *NullableABSCreatedAllOfCreator) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableABSCreatedAllOfCreator(val *ABSCreatedAllOfCreator) *NullableABSCreatedAllOfCreator {
	return &NullableABSCreatedAllOfCreator{value: val, isSet: true}
}

func (v NullableABSCreatedAllOfCreator) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableABSCreatedAllOfCreator) UnmarshalJSON(src []byte) error {
	v.isSet = true
